...
| `fuel` | `1` para Gasolina<br> `2` para Álcool<br> `3` para Flex<br> `4` para Gás Natural<br> `5` para Diesel<br> `6` para Hibrido<br> `7` para Elétrico | string | Não<sup>1</sup> | Tipo de combustível |
